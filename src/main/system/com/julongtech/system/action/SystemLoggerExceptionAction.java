...
public class SystemLoggerExceptionAction {
	...
	public Map<String,Object> selectLoggerListByPage(SystemLoggerExceptionVO systemLoggerExceptionVO,PageParam<SystemLoggerExceptionDTO> page) throws Exception{
