...
<body class="easyui-layout" style="padding:0px;margin:0px;" >  
    <div data-options="region:'center',title:'添加角色',iconCls:'icon-user-add'" >
   		...
   		<div id="form_div" class="easyui-panel" data-options="iconCls:'icon-user-list',title:'系统角色信息管理'" border="true"  noheader="true"   fit="true" style="width:100%;height:100%;padding:0px 0px 32px 0px;text-align:center;">
   		 ...
   		 <form id="paramForm" method="post" name="paramForm" action="">  
   			<div style="margin-top:15px;">
				...
				<input class="easyui-textbox" id="roleName" type="text" style="width:70%;height:32px;padding:10px" name="roleName" value="" data-options="prompt:'请输入角色名称',required:true,validType: ['CN_EN_NO[]','maxLenght[50]']">
			</div>
   			<div style="margin-top:15px">
   			...
   			<div style="margin-top:15px">
				...
				<input class="easyui-textbox" type="text" style="width:70%;height:32px;padding:10px" name="roleDesc" value="" data-options="prompt:'请输入角色描述',validType: ['CN_EN_NO[]','maxLenght[500]']">
			</div>
